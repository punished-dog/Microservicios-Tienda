...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(ResenaNoEncontradoException.class)
    public ResponseEntity<ErrorResponse> manejarNoEncontrado(ResenaNoEncontradoException ex, WebRequest request) {
